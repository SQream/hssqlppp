...
>         CatCreateFunction "!odbc-ascii" ["text"] False "int4" True
>        ,CatCreateFunction "!odbc-ascii" ["char"] False "int4" True
>        ,CatCreateFunction "!odbc-ascii" ["varchar"] False "int4" True
...
>        ,CatCreateFunction "!odbc-bit_length" ["text"] False "int4" True
>        ,CatCreateFunction "!odbc-bit_length" ["char"] False "int4" True
>        ,CatCreateFunction "!odbc-bit_length" ["varchar"] False "int4" True
...
>        ,CatCreateFunction "!odbc-char" ["int4"] False "char" True
...
>        ,CatCreateFunction "!odbc-char_length" ["text"] False "int4" True
>        ,CatCreateFunction "!odbc-char_length" ["char"] False "int4" True
>        ,CatCreateFunction "!odbc-char_length" ["varchar"] False "int4" True
...
>        ,CatCreateFunction "!odbc-character_length" ["text"] False "int4" True
>        ,CatCreateFunction "!odbc-character_length" ["char"] False "int4" True
>        ,CatCreateFunction "!odbc-character_length" ["varchar"] False "int4" True
...
>       ,CatCreateFunction "!odbc-concat" ["text","text"] False "text" True
>       ,CatCreateFunction "!odbc-concat" ["char","char"] False "char" True
>       ,CatCreateFunction "!odbc-concat" ["varchar","varchar"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-difference" ["text","text"] False "int4" True
>       ,CatCreateFunction "!odbc-difference" ["char","char"] False "int4" True
>       ,CatCreateFunction "!odbc-difference" ["varchar","varchar"] False "int4" True
...
>       ,CatCreateFunction "!odbc-insert" ["text","int4","int4","text"] False "text" True
>       ,CatCreateFunction "!odbc-insert" ["char","int4","int4","char"] False "char" True
>       ,CatCreateFunction "!odbc-insert" ["varchar","int4","int4","varchar"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-lcase" ["text"] False "text" True
>       ,CatCreateFunction "!odbc-lcase" ["char"] False "char" True
>       ,CatCreateFunction "!odbc-lcase" ["varchar"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-left" ["text","int4"] False "text" True
>       ,CatCreateFunction "!odbc-left" ["char","int4"] False "char" True
>       ,CatCreateFunction "!odbc-left" ["varchar","int4"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-length" ["text"] False "text" True
>       ,CatCreateFunction "!odbc-length" ["char"] False "char" True
>       ,CatCreateFunction "!odbc-length" ["varchar"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-locate" ["text","text"] False "int4" True
>       ,CatCreateFunction "!odbc-locate" ["text","text","int4"] False "int4" True
>       ,CatCreateFunction "!odbc-locate" ["char","char"] False "int4" True
>       ,CatCreateFunction "!odbc-locate" ["char","char","int4"] False "int4" True
>       ,CatCreateFunction "!odbc-locate" ["varchar","varchar"] False "int4" True
>       ,CatCreateFunction "!odbc-locate" ["varchar","varchar","int4"] False "int4" True

LTRIM(string_exp) (ODBC 1.0)
Returns the characters of string_exp, with leading blanks removed.

>       ,CatCreateFunction "!odbc-ltrim" ["text"] False "text" True
>       ,CatCreateFunction "!odbc-ltrim" ["char"] False "char" True
>       ,CatCreateFunction "!odbc-ltrim" ["varchar"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-octet_length" ["text"] False "int4" True
>       ,CatCreateFunction "!odbc-octet_length" ["char"] False "int4" True
>       ,CatCreateFunction "!odbc-octet_length" ["varchar"] False "int4" True
...
>       ,CatCreateFunction "!odbc-repeat" ["text","int4"] False "text" False
>       ,CatCreateFunction "!odbc-repeat" ["char","int4"] False "char" False
>       ,CatCreateFunction "!odbc-repeat" ["varchar","int4"] False "varchar" False
...
>       ,CatCreateFunction "!odbc-replace" ["text","text","text"] False "text" True
>       ,CatCreateFunction "!odbc-replace" ["char","char","char"] False "char" True
>       ,CatCreateFunction "!odbc-replace" ["varchar","varchar","varchar"] False "varchar" True

RIGHT(string_exp, count) (ODBC 1.0)
Returns the rightmost count characters of string_exp.

>       ,CatCreateFunction "!odbc-right" ["text","int4"] False "text" True
>       ,CatCreateFunction "!odbc-right" ["char","int4"] False "char" True
>       ,CatCreateFunction "!odbc-right" ["varchar","int4"] False "varchar" True


RTRIM(string_exp) (ODBC 1.0)
Returns the characters of string_exp with trailing blanks removed.

>       ,CatCreateFunction "!odbc-rtrim" ["text"] False "text" True
>       ,CatCreateFunction "!odbc-rtrim" ["char"] False "char" True
>       ,CatCreateFunction "!odbc-rtrim" ["varchar"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-soundex" ["text"] False "text" True
>       ,CatCreateFunction "!odbc-soundex" ["char"] False "char" True
>       ,CatCreateFunction "!odbc-soundex" ["varchar"] False "varchar" True


SPACE(count) (ODBC 2.0)
Returns a character string consisting of count spaces.

>       ,CatCreateFunction "!odbc-space" ["int4"] False "char" True
...
>       ,CatCreateFunction "!odbc-substring" ["text","int4","int4"] False "text" True
>       ,CatCreateFunction "!odbc-substring" ["char","int4","int4"] False "char" True
>       ,CatCreateFunction "!odbc-substring" ["varchar","int4","int4"] False "varchar" True
...
>       ,CatCreateFunction "!odbc-ucase" ["text"] False "text" True
>       ,CatCreateFunction "!odbc-ucase" ["char"] False "char" True
>       ,CatCreateFunction "!odbc-ucase" ["varchar"] False "varchar" True
...
>        ++ [CatCreateFunction "!odbc-atan2" [n] False n True | n <- floatTypes]
...
>        ++ [CatCreateFunction "!odbc-round" [n,m] False n True | n <- numTypes, m <- intTypes]
...
>        CatCreateFunction "!odbc-current_date" [] False "date" True
...
>       ,CatCreateFunction "!odbc-current_time" [] False "time" True
...
>       ,CatCreateFunction "!odbc-current_timestamp" [] False "timestamp" True

CURDATE( ) (ODBC 1.0)
Returns the current date.

>       ,CatCreateFunction "!odbc-curdate" [] False "date" True

CURTIME( ) (ODBC 1.0)
Returns the current local time.

>       ,CatCreateFunction "!odbc-curtime" [] False "time" True]
...
>       ++ [CatCreateFunction "!odbc-dayname" [d] False "varchar" True | d <- dateTypes]
...
>       ++ [CatCreateFunction "!odbc-dayofmonth" [d] False "int4" True | d <- dateTypes]
...
>       ++ [CatCreateFunction "!odbc-dayofweek" [d] False "int4" True | d <- dateTypes]
...
>       ++ [CatCreateFunction "!odbc-dayofyear" [d] False "int4" True | d <- dateTypes]
...
>       ++ [CatCreateFunction "!odbc-hour" [d] False "int4" True | d <- timeTypes]
...
>       ++ [CatCreateFunction "!odbc-monthname" [d] False "varchar" True | d <- dateTypes]

NOW( ) (ODBC 1.0)
Returns current date and time as a timestamp value.

>       ++ [CatCreateFunction "!odbc-now" [] False "timestamp" True ]
...
>       ++ [CatCreateFunction "!odbc-quarter" [d] False "int4" True | d <- dateTypes]
...
>       ++ [CatCreateFunction "!odbc-second" [d] False "int4" True | d <- timeTypes]
...
>        ++ [CatCreateFunction "!odbc-timestampadd" ["int4","int4","date"] False "date" False
>       ,CatCreateFunction "!odbc-timestampadd" ["int4","int4","time"] False "time" False
>       ,CatCreateFunction "!odbc-timestampadd" ["int4","int4","timestamp"] False "timestamp" False
...
>       ,CatCreateFunction "!odbc-timestampdiff" ["int4","time","time"] False "int4" False
>       ,CatCreateFunction "!odbc-timestampdiff" ["int4","date","date"] False "int4" False
>       ,CatCreateFunction "!odbc-timestampdiff" ["int4","timestamp","timestamp"] False "int4" False
>       ]
...
>       ++ [CatCreateFunction "!odbc-week" [d] False "int4" True | d <- dateTypes]
...
>       ++ [CatCreateFunction "!odbc-year" [d] False "int4" True | d <- dateTypes]
...
>       ++ [CatCreateFunction "!odbc-database" [] False "varchar" True]
...
>       ++ [CatCreateFunction "!odbc-ifnull" [t,t] False t True | t <- allTypes]
...
>       ++ [CatCreateFunction "!odbc-user" [] False "varchar" True ]
...
>    ++ [CatCreateFunction "!odbc-convert" [t,"int4"] False t True
