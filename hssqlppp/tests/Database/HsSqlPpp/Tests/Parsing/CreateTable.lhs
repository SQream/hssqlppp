...
>                          Nothing [NotNullConstraint ea "", IdentityConstraint ea "" (Just(1,1))]][] Nothing NoReplace]
>
>      ,s "create table tbl  (\n\
>         \  fld int not null identity(-1,-1));"
>       [CreateTable ea (name "tbl")
...
>       [CreateTable ea (name "tbl")
>        [AttributeDef ea (Nmc "fld") (st "int")
>                          Nothing [NotNullConstraint ea "", IdentityConstraint ea "" Nothing]][] Nothing NoReplace]
>
